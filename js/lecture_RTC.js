const APP_ID = "2fa3d707afcf41d9834f7bc71caaa263"
...
let joinRoomInit = async () =>{
    ...
    await channel.join()
    channel.on('MemberJoin', handleMemberJoined)
...
let handleUserLeft = async (user) => {
    ...
    if(userIdDisplayerFrame === `user-container-${user.uid}`){
...
let toggleScreen = async (e) => {
    ...
    if(!sharingScreen){
       ...
       let player = ` <div class="video__container" id="user-container-${uid}">
        ...
        userIdDisplayerFrame = `user-container-${uid}`
